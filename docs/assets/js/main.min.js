!(function (i) {
  ...
  $(".modal").click(function (i) {
    "wrapper" == i.target.parentNode.classList[0] && $(".modal").fadeOut();
  }),
...
window.addEventListener("scroll", () => {
  ...
  document.addEventListener("click", function (i) {
    (i.target.classList.contains("burger-icon") ||
      i.target.classList.contains("burger-logo") ||
      menu.classList.contains("active") ||
      i.target.closest(".menu__inner")) &&
